...
- data ethics
- machine learning
excerpt: I show how feature choices, opaque models, and real‑world data combine to
  keep privileged candidates ahead, then give a concrete script you can run this week
  to expose disparity.
slug: algorithmic-hiring-tools-and-the-hidden-socioeconomic-bias-they-perpet
