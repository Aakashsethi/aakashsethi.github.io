...
- real‑time systems
- engineering
excerpt: I show how a 150 ms blind spot cost a major bank millions, then walk through
  the engineering choices that shrink latency below 100 ms without sacrificing detection
  quality.
slug: when-microlatency-beats-model-complexity-in-realtime-fraud-detection
category: Fintech
---
